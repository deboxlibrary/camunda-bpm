...
The Root Types schema file is `extension/src/main/resources/camunda.graphqls`<br>
 ...
 * properties in [application.properties](https://github.com/camunda/camunda-bpm-graphql/blob/master/extension/src/main/resources/application.properties) <br>
